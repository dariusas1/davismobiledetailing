...
import slotAvailabilityService from '../services/slotAvailabilityService.js';
...
export async function getRealTimeAvailability(req, res) {
    try {
...
export async function validateDateTime(req, res) {
    try {
...
export async function getWeatherConditions(req, res) {
    try {
        const { date } = req.query;
...
export async function getRecommendedSlots(req, res) {
    try {
