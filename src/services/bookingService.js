...
const { validateBookingData } = require('../utils/bookingValidationUtils');
...
const checkAvailability = async ({ date, serviceType, duration }) => {
  try {
...
const processPayment = async ({ amount, currency, customerEmail, description }) => {
  try {
